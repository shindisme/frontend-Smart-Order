...
import { getSessionId } from '../../utils/cartStorage';  // ← IMPORT getSessionId
import {
    MdPayment,
    MdCancel,
    MdCheckCircle,
...
function OrderTracking() {
    ...
    const sessionId = getSessionId();  // ← LẤY session_id
                        ...
                        if (detailRes?.data && detailRes.data.orders) {
                            ...
                            if (myOrders.length > 0) {
                                ...
                                myInvoices.push({
                                    ...
                                    orders: myOrders,
                                    total: myTotal,
                                    final_total: myTotal - (detailRes.data.discount || 0)
                                });
                            }
                        }
                    } catch (err) {
